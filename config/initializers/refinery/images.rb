Refinery::Images.configure do |config|
  ...
  # config.dragonfly_secret = "118d8c6e22aed5c45d60c81ff57ec5451b2f1bb7655cb4f5"
  # If you decide to trust file extensions replace :ext below with :format
  # config.dragonfly_url_format = "/system/images/:job/:basename.:ext"
  # config.datastore_root_path = "f:/Ruby/AptanaStudio3-Workspace/myForum/public/system/refinery/images"
