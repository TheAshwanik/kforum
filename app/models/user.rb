class User < ActiveRecord::Base
  ...
  attr_accessible :email, :password, :password_confirmation, :remember_me, :username, :user_id, :mail_subscription , :plugins
  ...
  # Based on http://www.synaptian.com/blogs/integrating-refinery-rails-3-2-into-your-existing-rails-app
  # Everything here is added because We will need to integrate Refinery authentication User models 
  # with the model we generated with devise.
  # 
  # Refinery changes starts here
  #
